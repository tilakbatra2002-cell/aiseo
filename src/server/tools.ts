...
export const TOOL_REGISTRY: ToolDef[] = [
  ...
  { key: 'keyword_data', name: 'Keyword Data', category: 'Research', description: 'Search-volume and keyword metrics provider.', requiresIntegration: 'dataforseo' },
  { key: 'backlink_data', name: 'Backlink Data', category: 'Research', description: 'Backlink index lookups (Ahrefs/Semrush/DataForSEO).', requiresIntegration: 'backlink_provider' },
